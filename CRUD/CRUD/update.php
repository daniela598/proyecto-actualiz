        ...
        <div class="table-wrapper">
            ...
            <?php
				...
				if(isset($_POST) && !empty($_POST)){
					...
					$id_usuarios= $usuarios->sanitaze($_POST['id']);
					$res = $usuarios->update($nombre, $usuario, $email, $contraseña, $id_usuarios);
					if($res){
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<input type="text" name="contraseña" id="contraseña" class='form-control' maxlength="15" required value="<?php echo $datos_usuario->contraseña;?>">
				</div>
